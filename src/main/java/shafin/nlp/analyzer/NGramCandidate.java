...
public class NGramCandidate {
	...
	public List<String> getNGramCandidateKeysFilteringSW(int min, int max) throws IOException {
		...
		List<String> nGramTokens = analyzer.getNGramTokens(DOCUMENT_TEXT);
		analyzer.close();
	...
	public static void main(String[] args) throws IOException {
		...
		String text = "নোয়াখালীর হাতিয়া উপজেলার চরকিং ইউনিয়নে ভোট কেন্দ্রে অনেকে যাওয়ার পথে আজ মঙ্গলবার সকাল সাতটার দিকে দুই নির্বাচনী কর্মকর্তাকে গুলি করেছে দুর্বৃত্তরা। দাসপাড়া বালিকা উচ্চবিদ্যালয় কেন্দ্রের কাছাকাছি এ ঘটনা ঘটে।"
