...
public class PosTagger {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
		...
		tagList.add("/VM");
		tagList.add("/VAUX");
		List<String> out = findTaggedTokens(sample, tagList);
		
		for(String token : out){
			System.out.println(VerbSuffixFilter.matchSuffix(token));
		}
	}

	public static String getPosTagged(String text) throws ClassNotFoundException, IOException {
		// MaxentTagger tagger = new
		// MaxentTagger("taggers/bengaliModelFile.tagger");
	...
	public static List<String> findTaggedTokens(String text, List<String> tagList) throws ClassNotFoundException, IOException{
