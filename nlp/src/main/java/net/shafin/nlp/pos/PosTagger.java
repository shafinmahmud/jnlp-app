...
public class PosTagger {
    ...
    private static final String[] NOUN_TAG_LIST = {"NN", "NNP"};
    /*FULL TAG LIST : http://www.isical.ac.in/~utpal/docs/POS-Tag%20List.pdf */
    ...
    public List<String> findNounTaggedTokens() {
        return findTaggedTokens(NOUN_TAG_LIST);
    }
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        System.out.println(posTagger.findNounTaggedTokens());
    }
}
