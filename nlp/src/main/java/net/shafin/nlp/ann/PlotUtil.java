...
public class PlotUtil {
     ...
     */
    public static void plotTrainingData(INDArray features, INDArray labels,
                                        INDArray backgroundIn, INDArray backgroundOut, int nDivisions) {
        ...
        JPanel panel = new ChartPanel(createChart(backgroundData, mins, maxs,
                nDivisions, createDataSetTrain(features, labels)));
     ...
     * @param nDivisions    Number of points (per axis, for the backgroundIn/backgroundOut arrays)
     */
    public static void plotTestData(INDArray features, INDArray labels, INDArray predicted,
                                    INDArray backgroundIn, INDArray backgroundOut, int nDivisions) {
